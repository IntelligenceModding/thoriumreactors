...
public class FluidEnrichingRecipeCategory implements IRecipeCategory<FluidEnrichingRecipe> {
    ...
    @Override
    public void draw(@NotNull FluidEnrichingRecipe recipe, @NotNull IRecipeSlotsView recipeSlotsView, @NotNull PoseStack stack, double mouseX, double mouseY) {
        ...
        ScreenUtil.drawCenteredText("Fluid Enriching", stack, getBackground().getWidth() / 2, 6);
