...
public class OxidizingRecipeCategory implements IRecipeCategory<OxidizingRecipe> {
    ...
    public void draw(@NotNull OxidizingRecipe recipe, @NotNull IRecipeSlotsView recipeSlotsView, @NotNull GuiGraphics graphics, double mouseX, double mouseY) {
        ...
        ScreenUtil.drawCenteredText("Uranium Oxidization", graphics, getBackground().getWidth() / 2, 6, false);
    ...
    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, OxidizingRecipe recipe, @NotNull IFocusGroup focusGroup) {
