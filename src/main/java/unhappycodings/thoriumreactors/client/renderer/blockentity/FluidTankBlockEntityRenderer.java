package unhappycodings.thoriumreactors.client.renderer.blockentity;
...
public class FluidTankBlockEntityRenderer implements BlockEntityRenderer<FluidTankBlockEntity> {
    ...
    public void render(@NotNull FluidTankBlockEntity entity, float pPartialTick, @NotNull PoseStack stack, @NotNull MultiBufferSource buffer, int pPackedLight, int pPackedOverlay) {
        ...
        if (entity.getFluidAmountIn() > 0) {
            ...
            drawBox(stack, boxVertexConsumer, entity.getFluidIn(), 0, 0f, 0, 11, 0.01f, 11, 0, 0, 16, 16, height, 0.032f, pPackedLight);
        }
    }
    ...
    public static void drawBox(PoseStack stack, VertexConsumer buffer, FluidStack fluid, float pX, float pY, float pZ, float sX, float sY, float sZ, float pUOffset, float pVOffset, float pWidth, float pHeight, float height, float yOffset, int pPackedLight) {
        ...
        drawPlane(stack, buffer, fluid, RenderUtil.Perspective.UP, height, pX, pY, pZ, sX, sY, sZ, pUOffset, pVOffset, pWidth, pHeight, yOffset, pPackedLight);
        drawPlane(stack, buffer, fluid, RenderUtil.Perspective.DOWN, height, pX, pY, pZ, sX, sY, sZ, pUOffset, pVOffset, pWidth, pHeight, yOffset, pPackedLight);
        drawPlane(stack, buffer, fluid, RenderUtil.Perspective.RIGHT, height, pX, pY, pZ, sX, sY, sZ, pUOffset, pVOffset, pWidth, pHeight, yOffset, pPackedLight);
        drawPlane(stack, buffer, fluid, RenderUtil.Perspective.LEFT, height, pX, pY, pZ, sX, sY, sZ, pUOffset, pVOffset, pWidth, pHeight, yOffset, pPackedLight);
        drawPlane(stack, buffer, fluid, RenderUtil.Perspective.FRONT, height, pX, pY, pZ, sX, sY, sZ, pUOffset, pVOffset, pWidth, pHeight, yOffset, pPackedLight);
        drawPlane(stack, buffer, fluid, RenderUtil.Perspective.BACK, height, pX, pY, pZ, sX, sY, sZ, pUOffset, pVOffset, pWidth, pHeight, yOffset, pPackedLight);
