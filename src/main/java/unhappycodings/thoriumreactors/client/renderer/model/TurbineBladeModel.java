...
public class TurbineBladeModel<T extends Entity> extends EntityModel<T> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        bb_main.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(4, 4).addBox(-1.0F, -0.25F, 2.0F, 2.0F, 0.5F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(17, 0).addBox(-1.75F, -0.5F, 4.0F, 3.5F, 1.0F, 19.75F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -8.0F, 0.0F, -2.5251F, 0.4574F, -2.1129F));

        bb_main.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(17, 0).addBox(-1.75F, -0.5F, 4.0F, 3.5F, 1.0F, 19.75F, new CubeDeformation(0.0F))
        ...
        bb_main.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(17, 0).addBox(-1.75F, -0.5F, 4.0F, 3.5F, 1.0F, 19.75F, new CubeDeformation(0.0F))
        ...
        bb_main.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(17, 0).addBox(-1.75F, -0.5F, 4.0F, 3.5F, 1.0F, 19.75F, new CubeDeformation(0.0F))
        ...
        bb_main.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(4, 4).addBox(-1.0F, -0.25F, 2.0F, 2.0F, 0.5F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(17, 0).addBox(-1.75F, -0.5F, 4.0F, 3.5F, 1.0F, 19.75F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -8.0F, 0.0F, 0.0F, 0.0F, -0.8727F));

        bb_main.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(17, 0).addBox(-1.75F, -0.5F, 4.0F, 3.5F, 1.0F, 19.75F, new CubeDeformation(0.0F))
        ...
        bb_main.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(4, 4).addBox(-1.0F, -0.25F, 2.0F, 2.0F, 0.5F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(17, 0).addBox(-1.75F, -0.5F, 4.0F, 3.5F, 1.0F, 19.75F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -8.0F, 0.0F, -3.1416F, 0.0F, -2.2689F));

        bb_main.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(17, 0).addBox(-1.75F, -0.5F, 4.0F, 3.5F, 1.0F, 19.75F, new CubeDeformation(0.0F))
                .texOffs(4, 4).addBox(-1.0F, -0.25F, 2.0F, 2.0F, 0.5F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -8.0F, 0.0F, 1.5708F, -0.6981F, -1.5708F));
