...
public class FluidRenderUtil {
    ...
    public FluidRenderUtil(long capacity, boolean showCapacity, int width, int height) {
        this(capacity, showCapacity ? TooltipMode.SHOW_AMOUNT_AND_CAPACITY : TooltipMode.SHOW_AMOUNT, width, height);
    }

    private FluidRenderUtil(long capacity, TooltipMode tooltipMode, int width, int height) {
