...
public class CraftingUtil {
    ...
    public static void refreshTable(ThoriumCraftingTableBlockEntity entity) {
        ...
        for (int i = 0; i < ThoriumCraftingRecipe.MAX_WIDTH * ThoriumCraftingRecipe.MAX_HEIGHT; i++) inventory.setItem(i, entity.getItem(i).is(Items.AIR) ? Items.AIR.getDefaultInstance(): entity.getItem(i));
