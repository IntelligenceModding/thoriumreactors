...
public class ClientFluidEnricherDataPacket implements IPacket {
    ...
    public ClientFluidEnricherDataPacket(BlockPos pos, int energy, int maxRecipeTime, int recipeTime, int fluidIn, int fluidOut, String fluidTypeIn, String fluidTypeOut, boolean powerable, int redstoneMode) {
        this.pos = pos;
        this.energy = energy;
    ...
    public static ClientFluidEnricherDataPacket decode(FriendlyByteBuf buffer) {
        return new ClientFluidEnricherDataPacket(buffer.readBlockPos(), buffer.readInt(), buffer.readInt(), buffer.readInt(), buffer.readInt(), buffer.readInt(), buffer.readUtf(), buffer.readUtf(), buffer.readBoolean(), buffer.readInt());
    }
    ...
    public void handle(NetworkEvent.Context context) {
        ...
        if (!(machine instanceof MachineFluidEnricherBlockEntity blockEntity)) return;
