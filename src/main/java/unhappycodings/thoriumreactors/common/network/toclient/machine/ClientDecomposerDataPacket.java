...
public class ClientDecomposerDataPacket implements IPacket {
    ...
    public ClientDecomposerDataPacket(BlockPos pos, int energy, int maxRecipeTime, int recipeTime, int fluidIn, int fluidOut, String fluidTypeIn, String fluidTypeOut, boolean powerable, int redstoneMode) {
        this.pos = pos;
        this.energy = energy;
    ...
    public static ClientDecomposerDataPacket decode(FriendlyByteBuf buffer) {
        return new ClientDecomposerDataPacket(buffer.readBlockPos(), buffer.readInt(), buffer.readInt(), buffer.readInt(), buffer.readInt(), buffer.readInt(), buffer.readUtf(), buffer.readUtf(), buffer.readBoolean(), buffer.readInt());
    }
