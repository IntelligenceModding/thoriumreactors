...
public class ClientUraniumOxidizerDataPacket implements IPacket {
    ...
    public ClientUraniumOxidizerDataPacket(BlockPos pos, int energy, int maxRecipeTime, int recipeTime, int fluidIn, int fluidOut, String fluidTypeIn, String fluidTypeOut, boolean powerable, int redstoneMode) {
        this.pos = pos;
        this.energy = energy;
    ...
    public static ClientUraniumOxidizerDataPacket decode(FriendlyByteBuf buffer) {
        return new ClientUraniumOxidizerDataPacket(buffer.readBlockPos(), buffer.readInt(), buffer.readInt(), buffer.readInt(), buffer.readInt(), buffer.readInt(), buffer.readUtf(), buffer.readUtf(), buffer.readBoolean(), buffer.readInt());
    }
    ...
    public void handle(NetworkEvent.Context context) {
        ...
        if (!(machine instanceof MachineUraniumOxidizerBlockEntity blockEntity)) return;
