...
import unhappycodings.thoriumreactors.common.container.CraftingTableContainer;

public class CraftingTableBlockEntity extends BaseContainerBlockEntity implements MenuProvider {
    public LootContext.Builder lootcontextBuilder;
    public NonNullList<ItemStack> items;

    public CraftingTableBlockEntity(BlockPos pPos, BlockState pBlockState) {
    ...
    protected AbstractContainerMenu createMenu(int pContainerId, @NotNull Inventory pInventory) {
        return new CraftingTableContainer(pContainerId, pInventory, getBlockPos(), getLevel());
    }
