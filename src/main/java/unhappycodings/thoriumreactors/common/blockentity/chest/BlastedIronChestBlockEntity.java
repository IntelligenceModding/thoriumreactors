...
public class BlastedIronChestBlockEntity extends ChestBlockEntity {
    ...
    public BlastedIronChestBlockEntity(BlockPos pPos, BlockState pBlockState) {
        ...
        this.counter = new ContainerOpenersCounter() {
            ...
            protected boolean isOwnContainer(@NotNull Player player) {
                if (!(player.containerMenu instanceof ChestMenu)) {
                    ...
                    return container == BlastedIronChestBlockEntity.this || container instanceof CompoundContainer && ((CompoundContainer) container).contains(BlastedIronChestBlockEntity.this);
                }
            }
        };
    ...
    public BlockEntityType<?> getType() {
        return ModBlockEntities.BLASTED_IRON_CHEST_BLOCK.get();
    }
    ...
    protected AbstractContainerMenu createMenu(int pContainerId, @NotNull Inventory pInventory) {
        return new BlastedIronChestContainer(pContainerId, pInventory, getBlockPos(), getLevel(), getContainerSize());
    }
