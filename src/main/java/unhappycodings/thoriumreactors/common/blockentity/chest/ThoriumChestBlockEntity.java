...
public class ThoriumChestBlockEntity extends ChestBlockEntity {
    ...
    public ThoriumChestBlockEntity(BlockPos pPos, BlockState pBlockState) {
        ...
        this.counter = new ContainerOpenersCounter() {
            ...
            protected boolean isOwnContainer(@NotNull Player player) {
                if (!(player.containerMenu instanceof ChestMenu)) {
                    ...
                    return container == ThoriumChestBlockEntity.this || container instanceof CompoundContainer && ((CompoundContainer)container).contains(ThoriumChestBlockEntity.this);
                }
            }
        };
    ...
    public BlockEntityType<?> getType() {
        return ModBlockEntities.THORIUM_CHEST_BLOCK.get();
    }
