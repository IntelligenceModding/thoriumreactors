...
public class ModelAndBlockStatesProvider extends BlockStateProvider {
    ...
    protected void registerStatesAndModels() {
        ...
        simpleBlock(ModBlocks.SIMPLE_ENERGY_TANK.get(), models().withExistingParent(ItemUtil.getRegString(ModBlocks.SIMPLE_ENERGY_TANK.get()), new ResourceLocation(ThoriumReactors.MOD_ID, "block/fluid_tank")).texture("1", new ResourceLocation(ThoriumReactors.MOD_ID, "block/energy_tank")).texture("2", new ResourceLocation(ThoriumReactors.MOD_ID, "block/energy_tank_valve")).texture("particle", new ResourceLocation(ThoriumReactors.MOD_ID, "block/energy_tank")).renderType("cutout"));
        simpleBlock(ModBlocks.GENERIC_ENERGY_TANK.get(), models().withExistingParent(ItemUtil.getRegString(ModBlocks.GENERIC_ENERGY_TANK.get()), new ResourceLocation(ThoriumReactors.MOD_ID, "block/fluid_tank")).texture("1", new ResourceLocation(ThoriumReactors.MOD_ID, "block/energy_tank")).texture("2", new ResourceLocation(ThoriumReactors.MOD_ID, "block/energy_tank_valve")).texture("particle", new ResourceLocation(ThoriumReactors.MOD_ID, "block/energy_tank")).renderType("cutout"));
        simpleBlock(ModBlocks.PROGRESSIVE_ENERGY_TANK.get(), models().withExistingParent(ItemUtil.getRegString(ModBlocks.PROGRESSIVE_ENERGY_TANK.get()), new ResourceLocation(ThoriumReactors.MOD_ID, "block/fluid_tank")).texture("1", new ResourceLocation(ThoriumReactors.MOD_ID, "block/energy_tank")).texture("2", new ResourceLocation(ThoriumReactors.MOD_ID, "block/energy_tank_valve")).texture("particle", new ResourceLocation(ThoriumReactors.MOD_ID, "block/energy_tank")).renderType("cutout"));
        simpleBlock(ModBlocks.CREATIVE_ENERGY_TANK.get(), models().withExistingParent(ItemUtil.getRegString(ModBlocks.CREATIVE_ENERGY_TANK.get()), new ResourceLocation(ThoriumReactors.MOD_ID, "block/fluid_tank")).texture("1", new ResourceLocation(ThoriumReactors.MOD_ID, "block/energy_tank")).texture("2", new ResourceLocation(ThoriumReactors.MOD_ID, "block/energy_tank_valve")).texture("particle", new ResourceLocation(ThoriumReactors.MOD_ID, "block/energy_tank")).renderType("cutout"));
        ...
        machineBlock(ModBlocks.FLUID_ENRICHER_BLOCK.get(), new ResourceLocation(ThoriumReactors.MOD_ID, "block/fluid_enricher"), new ResourceLocation(ThoriumReactors.MOD_ID, "block/machine_valve_cyan"), new ResourceLocation(ThoriumReactors.MOD_ID, "block/machine_valve_yellow"), new ResourceLocation(ThoriumReactors.MOD_ID, "block/machine_valve_blue"), false);
        ...
        liquidBlock(ModBlocks.DEPLETED_MOLTEN_SALT_BLOCK.get());
