...
public class RecipeProvider extends net.minecraft.data.recipes.RecipeProvider {
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> pWriter) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.BLACK_INDUSTRAL_BLOCK_SMOOTH.get(), 8).define('A', ModBlocks.INDUSTRAL_BLOCK_SMOOTH.get()).define('B', Items.BLACK_DYE).pattern(" A ").pattern("ABA").pattern(" A ").unlockedBy("has_industrial_block", has(ModBlocks.INDUSTRAL_BLOCK.get())).save(pWriter);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.WHITE_INDUSTRAL_BLOCK_SMOOTH.get(), 8).define('A', ModBlocks.INDUSTRAL_BLOCK_SMOOTH.get()).define('B', Items.WHITE_DYE).pattern(" A ").pattern("ABA").pattern(" A ").unlockedBy("has_industrial_block", has(ModBlocks.INDUSTRAL_BLOCK.get())).save(pWriter);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.WHITE_INDUSTRAL_BLOCK_BIG_TILE.get(), 7).define('A', ModBlocks.BLACK_INDUSTRAL_BLOCK.get()).pattern("A A").pattern("AAA").pattern("A A").unlockedBy("has_industrial_block", has(ModBlocks.WHITE_INDUSTRAL_BLOCK.get())).save(pWriter);
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.WHITE_INDUSTRAL_BLOCK_BRICK.get(), 7).define('A', ModBlocks.BLACK_INDUSTRAL_BLOCK.get()).pattern("AAA").pattern(" A ").pattern("AAA").unlockedBy("has_industrial_block", has(ModBlocks.WHITE_INDUSTRAL_BLOCK.get())).save(pWriter);
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.WHITE_INDUSTRAL_BLOCK_PAVING.get(), 8).define('A', ModBlocks.BLACK_INDUSTRAL_BLOCK.get()).pattern("AAA").pattern("A A").pattern("AAA").unlockedBy("has_industrial_block", has(ModBlocks.WHITE_INDUSTRAL_BLOCK.get())).save(pWriter);
