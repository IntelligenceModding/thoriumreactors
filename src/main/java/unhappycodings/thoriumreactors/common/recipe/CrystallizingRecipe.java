...
public class CrystallizingRecipe implements Recipe<SimpleContainer> {
    ...
    public CrystallizingRecipe(ResourceLocation id, Ingredient inputSlot, FluidStack inputTank, int ticks, int operationAfterTicks) {
        this.id = id;
    ...
    @NotNull
    @Override
    public ItemStack assemble(@Nullable SimpleContainer pContainer, @Nullable RegistryAccess pRegistryAccess) {
    ...
    public RecipeType<?> getType() {
        return ModRecipes.CRYSTALLIZING_RECIPE_TYPE.get();
    }
    ...
    public static class Serializer implements RecipeSerializer<CrystallizingRecipe> {
        public static final CrystallizingRecipe.Serializer INSTANCE = new CrystallizingRecipe.Serializer();
        public static final ResourceLocation ID = new ResourceLocation(ThoriumReactors.MOD_ID, "crystallizing");
        ...
        @Nullable
        @Override
        public CrystallizingRecipe fromNetwork(@NotNull ResourceLocation id, @NotNull FriendlyByteBuf buf) {
            ...
            return new CrystallizingRecipe(id, outputSlot, inputTank, ticks, operationAfterTicks);
        }

        @Override
        public void toNetwork(@NotNull FriendlyByteBuf buf, CrystallizingRecipe recipe) {
