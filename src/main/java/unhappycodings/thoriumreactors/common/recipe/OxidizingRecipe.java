...
public class OxidizingRecipe implements Recipe<SimpleContainer> {
    ...
    public OxidizingRecipe(ResourceLocation id, Ingredient inputSlot, FluidStack inputTank, FluidStack outputTank, int ticks, int operationAfterTicks) {
        this.id = id;
    ...
    public RecipeType<?> getType() {
        return ModRecipes.OXIDIZING_RECIPE_TYPE.get();
    }
    ...
    public static class Serializer implements RecipeSerializer<OxidizingRecipe> {
        public static final OxidizingRecipe.Serializer INSTANCE = new OxidizingRecipe.Serializer();
        public static final ResourceLocation ID = new ResourceLocation(ThoriumReactors.MOD_ID, "oxidizing");
        ...
        @Nullable
        @Override
        public OxidizingRecipe fromNetwork(@NotNull ResourceLocation id, @NotNull FriendlyByteBuf buf) {
            ...
            return new OxidizingRecipe(id, inputSlot, inputTank, outputTank, ticks, operationAfterTicks);
        }

        @Override
        public void toNetwork(@NotNull FriendlyByteBuf buf, OxidizingRecipe recipe) {
