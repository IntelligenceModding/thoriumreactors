...
public class FluidEnrichingRecipe implements Recipe<SimpleContainer> {
    ...
    public FluidEnrichingRecipe(ResourceLocation id, Ingredient inputSlot, FluidStack inputTank, FluidStack outputTank, int ticks, int operationAfterTicks) {
        this.id = id;
    ...
    public RecipeType<?> getType() {
        return ModRecipes.FLUID_ENRICHING_RECIPE_TYPE.get();
    }
    ...
    public static class Serializer implements RecipeSerializer<FluidEnrichingRecipe> {
        public static final FluidEnrichingRecipe.Serializer INSTANCE = new FluidEnrichingRecipe.Serializer();
        public static final ResourceLocation ID = new ResourceLocation(ThoriumReactors.MOD_ID, "fluid_enriching");

        @NotNull
        @Override
        public FluidEnrichingRecipe fromJson(@NotNull ResourceLocation pRecipeId, @NotNull JsonObject pSerializedRecipe) {
            ...
            return new FluidEnrichingRecipe(pRecipeId, input, inputTank, outputTank, ticks, operationAfterTicks);
        }

        @Nullable
        @Override
        public FluidEnrichingRecipe fromNetwork(@NotNull ResourceLocation id, @NotNull FriendlyByteBuf buf) {
            ...
            return new FluidEnrichingRecipe(id, inputSlot, inputTank, outputTank, ticks, operationAfterTicks);
        }

        @Override
        public void toNetwork(@NotNull FriendlyByteBuf buf, FluidEnrichingRecipe recipe) {
