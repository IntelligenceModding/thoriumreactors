...
public class MachineFluidEvaporatorScreen extends MachineScreen<MachineFluidEvaporatorContainer> {
    ...
    protected void renderLabels(@NotNull PoseStack pPoseStack, int pMouseX, int pMouseY) {
        ...
        RenderUtil.drawCenteredText(Component.literal("Fluid Evaporation").getString(), pPoseStack, 90, 7);
        ...
        if (RenderUtil.mouseInArea(getGuiLeft() + 68, getGuiTop() + 17, getGuiLeft() + 105, getGuiTop() + 57, pMouseX, pMouseY))
            appendHoverText(pPoseStack, pMouseX, pMouseY, new String[]{"Vaporation Process: " + FormattingUtil.formatPercentNum(Math.abs(entity.getRecipeTime() - entity.getMaxRecipeTime()), entity.getMaxRecipeTime(), false)});
