...
public class MachineFluidCentrifugeScreen extends MachineScreen<MachineFluidCentrifugeContainer> {
    ...
    protected void renderBg(@NotNull GuiGraphics graphics, float partialTicks, int x, int y) {
        ...
        graphics.blit(getTexture(), getGuiLeft() + 37, getGuiTop() + 22, 176, 52, 4, 63); // Left Tank
        ...
        graphics.blit(getTexture(), getGuiLeft() + 70, getGuiTop() + 58, 184, 0, width, 9); // Process
    ...
    protected void renderLabels(@NotNull GuiGraphics graphics, int pMouseX, int pMouseY) {
        ...
        ScreenUtil.drawText(Component.translatable(FormattingUtil.getTranslatable("machines.fluid_centrifuge.name")).withStyle(ScreenUtil::notoSans), graphics, 10, 2, 11184810);
        ...
        if (ScreenUtil.mouseInArea(getGuiLeft() + 37, getGuiTop() + 20, getGuiLeft() + 54, getGuiTop() + 85, pMouseX, pMouseY))
