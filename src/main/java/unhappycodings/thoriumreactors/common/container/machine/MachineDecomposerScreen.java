...
public class MachineDecomposerScreen extends MachineScreen<MachineDecomposerContainer> {
    ...
    protected void renderLabels(@NotNull PoseStack pPoseStack, int pMouseX, int pMouseY) {
        ...
        RenderUtil.drawText(Component.translatable(FormattingUtil.getTranslatable("machines.decomposer.name")).withStyle(RenderUtil::notoSans), pPoseStack, 10, 2, 11184810);
