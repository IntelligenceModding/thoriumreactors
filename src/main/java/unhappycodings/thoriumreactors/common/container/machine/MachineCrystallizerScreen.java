...
public class MachineCrystallizerScreen extends MachineScreen<MachineCrystallizerContainer> {
    ...
    protected void renderLabels(@NotNull PoseStack pPoseStack, int pMouseX, int pMouseY) {
        ...
        ScreenUtil.drawText(Component.translatable(FormattingUtil.getTranslatable("machines.crystallizer.name")).withStyle(ScreenUtil::notoSans), pPoseStack, 10, 2, 11184810);
