...
public class MachineFluidEnricherScreen extends MachineScreen<MachineFluidEnricherContainer> {
    private MachineFluidEnricherContainer container;

    public MachineFluidEnricherScreen(MachineFluidEnricherContainer screenContainer, Inventory inv, Component titleIn) {
    ...
    protected void addElements() {
        MachineFluidEnricherBlockEntity tile = this.getMenu().getTile();
        // Dump Left
    ...
    protected void renderBg(@NotNull PoseStack matrixStack, float partialTicks, int x, int y) {
        ...
        MachineFluidEnricherBlockEntity entity = this.container.getTile();
    ...
    protected void renderLabels(@NotNull PoseStack pPoseStack, int pMouseX, int pMouseY) {
        ...
        RenderUtil.drawText(Component.translatable(FormattingUtil.getTranslatable("machines.fluid_enricher.name")).withStyle(RenderUtil::notoSans), pPoseStack, 10, 2, 11184810);
    ...
    public ResourceLocation getTexture() {
        return new ResourceLocation(ThoriumReactors.MOD_ID, "textures/gui/fluid_enricher_gui.png");
    }
