...
public class MachineFluidEvaporatorScreen extends MachineScreen<MachineFluidEvaporatorContainer> {
    ...
    protected void renderBg(@NotNull GuiGraphics graphics, float partialTicks, int x, int y) {
        ...
        graphics.blit(getTexture(), getGuiLeft() + 71, getGuiTop() + 32 + (22 - height), 184, 15 + (22 - height), 32, height); // Process
    ...
    protected void renderLabels(@NotNull GuiGraphics graphics, int pMouseX, int pMouseY) {
        ...
        ScreenUtil.drawText(Component.translatable(FormattingUtil.getTranslatable("machines.fluid_evaporator.name")).withStyle(ScreenUtil::notoSans), graphics, 10, 2, 11184810);
