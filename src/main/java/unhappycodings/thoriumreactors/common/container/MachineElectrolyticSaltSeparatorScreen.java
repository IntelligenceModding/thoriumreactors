...
public class MachineElectrolyticSaltSeparatorScreen extends MachineScreen<MachineElectrolyticSaltSeparatorContainer> {
    ...
    protected void renderLabels(@NotNull PoseStack pPoseStack, int pMouseX, int pMouseY) {
        ...
        if (RenderUtil.mouseInArea(getGuiLeft() + 78, getGuiTop() + 39, getGuiLeft() + 96, getGuiTop() + 57, pMouseX, pMouseY)) {
            String process = FormattingUtil.formatPercentNum(Math.abs(entity.getRecipeTime() - entity.getMaxRecipeTime()), entity.getMaxRecipeTime(), false);
            appendHoverText(pPoseStack, pMouseX, pMouseY, new String[]{"Separation Process: " + process});
        }
