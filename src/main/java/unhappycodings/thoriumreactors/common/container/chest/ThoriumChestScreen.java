...
public class ThoriumChestScreen extends BaseScreen<ThoriumChestContainer> {
    ...
    protected void renderLabels(@NotNull PoseStack pPoseStack, int pMouseX, int pMouseY) {
        ...
        RenderUtil.drawText(Component.literal("Thorium Chest").withStyle(RenderUtil::notoSans), pPoseStack, 10, 2, 11184810);
        ...
        pPoseStack.popPose();
        RenderUtil.drawText(Component.literal("Inventory").withStyle(RenderUtil::notoSans), pPoseStack, 44, 163, 11184810);
    }
