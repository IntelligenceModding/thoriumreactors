...
public class ModItems {
    ...
    public static final RegistryObject<Item> MOLYBDENUM_INGOT = Registration.ITEMS.register("molybdenum_ingot", () -> new Item(new Item.Properties().tab(ThoriumReactors.creativeTab)));
    public static final RegistryObject<Item> MOLYBDENUM_NUGGET = Registration.ITEMS.register("molybdenum_nugget", () -> new Item(new Item.Properties().tab(ThoriumReactors.creativeTab)));

    public static final RegistryObject<Item> MANGANESE_INGOT = Registration.ITEMS.register("manganese_ingot", () -> new Item(new Item.Properties().tab(ThoriumReactors.creativeTab)));
    public static final RegistryObject<Item> MANGANESE_NUGGET = Registration.ITEMS.register("manganese_nugget", () -> new Item(new Item.Properties().tab(ThoriumReactors.creativeTab)));

    public static final RegistryObject<Item> NICKEL_INGOT = Registration.ITEMS.register("nickel_ingot", () -> new Item(new Item.Properties().tab(ThoriumReactors.creativeTab)));
    public static final RegistryObject<Item> NICKEL_NUGGET = Registration.ITEMS.register("nickel_nugget", () -> new Item(new Item.Properties().tab(ThoriumReactors.creativeTab)));

    public static final RegistryObject<Item> ALUMINUM_INGOT = Registration.ITEMS.register("aluminum_ingot", () -> new Item(new Item.Properties().tab(ThoriumReactors.creativeTab)));
    public static final RegistryObject<Item> ALUMINUM_NUGGET = Registration.ITEMS.register("aluminum_nugget", () -> new Item(new Item.Properties().tab(ThoriumReactors.creativeTab)));

    public static final RegistryObject<Item> CHROMIUM_INGOT = Registration.ITEMS.register("chromium_ingot", () -> new Item(new Item.Properties().tab(ThoriumReactors.creativeTab)));
    public static final RegistryObject<Item> CHROMIUM_NUGGET = Registration.ITEMS.register("chromium_nugget", () -> new Item(new Item.Properties().tab(ThoriumReactors.creativeTab)));

    public static final RegistryObject<Item> NIOB_INGOT = Registration.ITEMS.register("niob_ingot", () -> new Item(new Item.Properties().tab(ThoriumReactors.creativeTab)));
    public static final RegistryObject<Item> NIOB_NUGGET = Registration.ITEMS.register("niob_nugget", () -> new Item(new Item.Properties().tab(ThoriumReactors.creativeTab)));

    public static final RegistryObject<Item> TITANIUM_INGOT = Registration.ITEMS.register("titanium_ingot", () -> new Item(new Item.Properties().tab(ThoriumReactors.creativeTab)));
    public static final RegistryObject<Item> TITANIUM_NUGGET = Registration.ITEMS.register("titanium_nugget", () -> new Item(new Item.Properties().tab(ThoriumReactors.creativeTab)));

    public static final RegistryObject<Item> URANIUM_INGOT = Registration.ITEMS.register("uranium_ingot", () -> new Item(new Item.Properties().tab(ThoriumReactors.creativeTab)));
    public static final RegistryObject<Item> URANIUM_NUGGET = Registration.ITEMS.register("uranium_nugget", () -> new Item(new Item.Properties().tab(ThoriumReactors.creativeTab)));

    public static final RegistryObject<Item> FLUORITE_INGOT = Registration.ITEMS.register("fluorite_ingot", () -> new Item(new Item.Properties().tab(ThoriumReactors.creativeTab)));
    public static final RegistryObject<Item> FLUORITE_NUGGET = Registration.ITEMS.register("fluorite_nugget", () -> new Item(new Item.Properties().tab(ThoriumReactors.creativeTab)));

    public static final RegistryObject<Item> COBALT_INGOT = Registration.ITEMS.register("cobalt_ingot", () -> new Item(new Item.Properties().tab(ThoriumReactors.creativeTab)));
    public static final RegistryObject<Item> COBALT_NUGGET = Registration.ITEMS.register("cobalt_nugget", () -> new Item(new Item.Properties().tab(ThoriumReactors.creativeTab)));
    ...
    public static final RegistryObject<ConfiguratorItem> CONFIGURATOR = Registration.ITEMS.register("configurator", () -> new ConfiguratorItem(new Item.Properties().tab(ThoriumReactors.creativeTab)));
    ...
    public static final RegistryObject<Item> DEPLETED_URANIUM = Registration.ITEMS.register("depleted_uranium", () -> new Item(new Item.Properties().tab(ThoriumReactors.creativeTab)));
    ...
    public static final RegistryObject<Item> TURBINE_BLADE = Registration.ITEMS.register("turbine_blade", () -> new Item(new Item.Properties().tab(ThoriumReactors.creativeTab)));
    ...
    public static final RegistryObject<BucketItem> DEPLETED_MOLTEN_SALT_BUCKET = Registration.ITEMS.register("depleted_molten_salt_bucket", () -> new BucketItem(ModFluids.SOURCE_DEPLETED_MOLTEN_SALT, new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1).tab(ThoriumReactors.creativeTab)));
