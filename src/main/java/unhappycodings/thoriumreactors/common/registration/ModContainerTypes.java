...
public class ModContainerTypes {
    ...
    public static final RegistryObject<MenuType<MachineFluidEnricherContainer>> FLUID_ENRICHER_CONTAINER = Registration.CONTAINER_TYPES.register("fluid_enricher_container", () -> IForgeMenuType.create((windowId, inv, data) -> new MachineFluidEnricherContainer(windowId, inv, data.readBlockPos(), inv.player.getCommandSenderWorld(), 0)));
    ...
    public static final RegistryObject<MenuType<FluidTankContainer>> FLUID_TANK_CONTAINER = Registration.CONTAINER_TYPES.register("fluid_tank_container", () -> IForgeMenuType.create((windowId, inv, data) -> new FluidTankContainer(windowId, inv, data.readBlockPos(), inv.player.getCommandSenderWorld(), 0)));
